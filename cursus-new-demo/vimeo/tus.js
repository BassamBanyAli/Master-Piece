...
(function(f) {
    ...
    {g=self}else{g=this}g.tus = f()}})(function()
    ...
    {var define,module,exports;return (function()
      ...
      {function r(e,n,t)
        ...
        {var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r)
      ...
      */
      ...
      var BaseUpload = /*#__PURE__*/function () {
        ...
        _createClass(BaseUpload, [{
          ...
          value: function _startParallelUpload() {
            ...
            var req; // Wait until all partial uploads are finished and we can send the PATCH request for
            // creating the final upload.
      
            Promise.all(uploads).then(function () {
              req = _this3._openRequest('PATCH', _this3.options.endpoint);
          ...
          /**
           * Create a new upload using the creation extension by sending a PATCH
          ...
          value: function _createUpload() {
            ...
            var req = this._openRequest('PATCH', this.options.endpoint);
          ...
          value: function _performUpload() {
            ...
            // cases, you can tell tus-js-client to use a PATCH request with the
      ...
      function openRequest(method, url, options) {
        ...
        console.log(method+' '+  777777777777);
